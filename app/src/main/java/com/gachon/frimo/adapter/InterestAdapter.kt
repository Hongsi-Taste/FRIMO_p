...
class InterestAdapter(private val dataSet: ArrayList<Interest>) : RecyclerView.Adapter<InterestAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = LayoutInflater.from(viewGroup.context).inflate(R.layout.friendly_community_interest_view, viewGroup, false)
